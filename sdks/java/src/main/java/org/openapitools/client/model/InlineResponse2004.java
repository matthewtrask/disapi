...
import org.openapitools.client.model.Restaurants;
...
public class InlineResponse2004 {
  ...
  public InlineResponse2004 data(List<Restaurants> data) {
    this.data = data;
    return this;
  }

  public InlineResponse2004 addDataItem(Restaurants dataItem) {
    if (this.data == null) {
      this.data = new ArrayList<Restaurants>();
    }
