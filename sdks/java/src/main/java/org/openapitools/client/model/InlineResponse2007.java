...
public class InlineResponse2007 {
  ...
  private List<Park> data = null;

  public InlineResponse2007 data(List<Park> data) {
    this.data = data;
    return this;
  }

  public InlineResponse2007 addDataItem(Park dataItem) {
    if (this.data == null) {
      this.data = new ArrayList<Park>();
    }
