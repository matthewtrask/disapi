...
module OpenapiClient
  class ResortForm
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'resortType')
        self.resort_type = attributes[:'resortType']
      end

      if attributes.has_key?(:'transportOptions')
        self.transport_options = attributes[:'transportOptions']
      end
    ...
    def hash
      [name, park_id, opening_year, resort_type, transport_options, category, num_of_rooms, quick_service_restaurants, table_service_restaurants, gift_shop, arcade, pool].hash
    end
