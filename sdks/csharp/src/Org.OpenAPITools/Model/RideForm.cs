...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RideForm :  IEquatable<RideForm>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RideForm" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as RideForm);
        }

        /// <summary>
        /// Returns true if RideForm instances are equal
        /// </summary>
        /// <param name="input">Instance of RideForm to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RideForm input)
        {
            if (input == null)
                return false;
