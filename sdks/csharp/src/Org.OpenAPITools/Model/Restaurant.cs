...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class Restaurant :  IEquatable<Restaurant>, IValidatableObject
    {
        ...
        public Restaurant(string id = default(string), string name = default(string), bool? quickService = default(bool?), bool? tableService = default(bool?), bool? alcohol = default(bool?), bool? diningPlan = default(bool?), List<string> mealTypes = default(List<string>), List<string> foodTypes = default(List<string>))
        {
            this.Id = id;
            this.Name = name;
