...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class Park :  IEquatable<Park>, IValidatableObject
    {
        ...
        public Park(string id = default(string), string name = default(string), string centralAttraction = default(string), string yearOpened = default(string), int? rideCount = default(int?), int? restaurantCount = default(int?), int? size = default(int?), int? resortCount = default(int?), bool? fireworks = default(bool?))
        {
            this.Id = id;
            this.Name = name;
