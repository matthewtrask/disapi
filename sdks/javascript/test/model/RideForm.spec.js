...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WaltDisneyWorldApi.RideForm();
  });
  ...
  describe('RideForm', function() {
    it('should create an instance of RideForm', function() {
      // uncomment below and update the code to test RideForm
      //var instance = new WaltDisneyWorldApi.RideForm();
      //expect(instance).to.be.a(WaltDisneyWorldApi.RideForm);
    });
