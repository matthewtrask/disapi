...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WaltDisneyWorldApi.Park = factory(root.WaltDisneyWorldApi.ApiClient);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('yearOpened')) {
        obj['yearOpened'] = ApiClient.convertToType(data['yearOpened'], 'String');
      }
